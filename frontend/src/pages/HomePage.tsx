...
export default function HomePage() {
  return (
    <PageLayout>
      ...
      {/* Integrity Sentinel flagship banner */}
      <section className="relative overflow-hidden bg-[#0a0916]" style={{ minHeight: "340px" }}>
        <img
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-r from-[#0a0916] via-[#0a0916]/75 to-transparent" />
        <div className="relative mx-auto flex min-h-[340px] max-w-6xl flex-col justify-center px-6 py-14 lg:px-10">
