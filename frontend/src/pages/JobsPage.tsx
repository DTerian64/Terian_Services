...
export default function JobsPage() {
  ...
  return (
    <PageLayout>
      <PageHero
        eyebrow="Careers"
        title="Join Terian Services."
        description="We work on hard engineering problems at the intersection of AI, enterprise software, and data. We hire the people who built and shipped the things — not just managed them."
      />
      ...
      <section className="mx-auto max-w-5xl px-6 py-16 lg:px-10">
        ...
        {error && (
          <p className="text-center text-slate-400">
            ...
            <a href="mailto:jobs@terian-services.com" className="text-teal-400 hover:text-teal-300">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        ...
        <div className="flex shrink-0 flex-col gap-2 sm:items-end">
          <button
            type="button"
            onClick={onApply}
            className="whitespace-nowrap rounded-md bg-teal-400 px-5 py-2.5 text-sm font-bold uppercase tracking-wider text-slate-950 transition hover:bg-teal-300"
          >
            Apply
          </button>
          <a
            href={`/jobs/${job.id}`}
            className="whitespace-nowrap text-center text-sm font-semibold text-teal-400 transition hover:text-teal-300"
          >
            View details →
          </a>
        </div>
