        ...
        <div className="space-y-8">
          <Section title="1. Who We Are">
            <p>
              ...
              (<a href="https://terian-services.com" className="text-teal-400 hover:text-teal-300">terian-services.com</a>).
          ...
          <Section title="5. Data Retention">
            <div className="rounded-md border border-teal-400/30 bg-teal-400/10 px-5 py-4 my-4 text-sm text-teal-100">
              ...
              <a href="mailto:support@terian-services.com" className="text-teal-400 hover:text-teal-300 underline">
          ...
          <Section title="7. Your Rights">
            ...
            <p className="mt-3">
              ...
              <a href="mailto:support@terian-services.com" className="text-teal-400 hover:text-teal-300">
                support@terian-services.com
              </a>
              .
            </p>
