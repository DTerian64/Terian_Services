  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-20 lg:px-10">
      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-violet-400 flex items-center gap-2">
        ...
        <button
          onClick={openDiagram}
          className="normal-case tracking-normal font-medium text-violet-400/70 hover:text-violet-300 underline underline-offset-2 transition"
        >
          (how it works)
        </button>
      </p>
        ...
        <div className="mt-6 rounded-xl border-2 border-white/10 bg-[#0f0d18] p-6">
          ...
          <div className="mt-4 flex gap-6">
            <span className="flex items-center gap-2 text-xs text-slate-400">
              <span className="inline-block h-0.5 w-6 rounded bg-violet-500" /> Requests
            </span>
            <span className="flex items-center gap-2 text-xs text-slate-400">
